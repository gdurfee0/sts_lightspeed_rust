...
pub enum Buff {
    ...
    Blasphemy,       // At the start of your turn, die.
    ...
    FlameBarrier, // When attacked, deals X damage back. Wears off at the start of your next turn.
    ...
    Malleable, // Upon receiving Attack damage, gains X Block. Block gain increases as Mallable is triggered.
    ...
    PainfulStabs, // Whenever you receive attack damage from this enemy, add X Wounds into your discard pile.
