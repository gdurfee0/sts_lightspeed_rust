...
impl NodeBuilderGrid {
    ...
    pub fn add_exit(&mut self, row: usize, col: usize, exit: Exit) {
        self.grid[row][col] = Some(
            self.grid[row][col]
                .take()
                .unwrap_or_default()
    ...
    pub fn has_exit(&self, row: usize, col: usize, exit: Exit) -> bool {
        self.grid[row][col]
            .as_ref()
...
mod test {
    ...
    impl NodeBuilderGrid {
        pub fn exits_as_vec(&self) -> [[u8; COLUMN_COUNT]; ROW_COUNT - 1] {
        ...
        pub fn exits_as_base64(&self) -> String {
            STANDARD.encode(
                self.exits_as_vec()
                    .as_flattened()
                    .chunks(21)
    ...
    pub static MAP_0SLAYTHESPIRE: Lazy<NodeGrid> = Lazy::new(|| NodeGrid {
        grid: [
            [
                Some(Node::new(Room::Monster, Exit::Straight)),
                None,
                Some(Node::new(Room::Monster, Exit::Straight)),
                None,
                None,
            ...
            [
                Some(Node::new(Room::Monster, Exit::Straight | Exit::Right)),
                None,
                Some(Node::new(Room::Monster, Exit::Straight | Exit::Right)),
                None,
                None,
                Some(Node::new(Room::Monster, Exit::Left | Exit::Straight)),
                None,
            ],
            [
                Some(Node::new(Room::Event, Exit::Straight)),
                Some(Node::new(Room::Monster, Exit::Right)),
                Some(Node::new(Room::Monster, Exit::Straight)),
                Some(Node::new(Room::Shop, Exit::Straight)),
                Some(Node::new(Room::Event, Exit::Left)),
                Some(Node::new(Room::Monster, Exit::Left)),
                None,
            ],
            [
                Some(Node::new(Room::Event, Exit::Straight)),
            ...
            [
                ...
                None,
                Some(Node::new(Room::Event, Exit::Left)),
                Some(Node::new(Room::Monster, Exit::Left | Exit::Right)),
                Some(Node::new(Room::Event, Exit::Straight)),
                None,
                None,
            ],
            [
                Some(Node::new(Room::Campfire, Exit::Straight)),
                Some(Node::new(Room::Elite, Exit::Straight)),
                Some(Node::new(Room::Campfire, Exit::Left)),
                None,
                Some(Node::new(Room::Monster, Exit::Left | Exit::Right)),
                None,
                None,
            ...
            [
                Some(Node::new(Room::Treasure, Exit::Straight)),
                Some(Node::new(Room::Treasure, Exit::Left | Exit::Right)),
                Some(Node::new(Room::Treasure, Exit::Right)),
                None,
                None,
                Some(Node::new(Room::Treasure, Exit::Left)),
                None,
            ],
            [
                Some(Node::new(Room::Campfire, Exit::Straight | Exit::Right)),
                None,
                Some(Node::new(Room::Monster, Exit::Straight | Exit::Right)),
                Some(Node::new(Room::Event, Exit::Straight)),
                Some(Node::new(Room::Campfire, Exit::Straight)),
            ...
            [
                ...
                Some(Node::new(Room::Monster, Exit::Straight)),
                Some(Node::new(Room::Campfire, Exit::Left)),
                Some(Node::new(Room::Event, Exit::Left | Exit::Right)),
                Some(Node::new(Room::Monster, Exit::Right)),
                None,
                None,
            ],
            [
                Some(Node::new(Room::BurningElite1, Exit::Right)),
                Some(Node::new(Room::Monster, Exit::Right)),
                Some(Node::new(Room::Event, Exit::Straight)),
                None,
                Some(Node::new(Room::Monster, Exit::Left)),
            ...
            [
                None,
                Some(Node::new(Room::Event, Exit::Left)),
                Some(Node::new(Room::Elite, Exit::Left | Exit::Straight)),
                Some(Node::new(Room::Campfire, Exit::Straight)),
                None,
                Some(Node::new(Room::Campfire, Exit::Right)),
                None,
            ],
            [
                Some(Node::new(Room::Elite, Exit::Straight)),
                ...
                None,
                None,
                Some(Node::new(Room::Elite, Exit::Left)),
            ],
            [
                Some(Node::new(Room::Campfire, Exit::Right)),
                None,
    ...
    static MAP_1SLAYTHESPIRE: Lazy<NodeGrid> = Lazy::new(|| NodeGrid {
        grid: [
            ...
            [
                ...
                Some(Node::new(Room::Event, Exit::Left | Exit::Right)),
                Some(Node::new(Room::Shop, Exit::Straight)),
                Some(Node::new(Room::Shop, Exit::Left | Exit::Straight)),
            ],
            [
                None,
                None,
                ...
                Some(Node::new(Room::Monster, Exit::Straight)),
                None,
                Some(Node::new(Room::Event, Exit::Left | Exit::Straight)),
                Some(Node::new(Room::Monster, Exit::Straight)),
            ],
            [
                None,
            ...
            [
                None,
                Some(Node::new(Room::Campfire, Exit::Straight)),
                Some(Node::new(Room::Elite, Exit::Right)),
                None,
                Some(Node::new(
                    Room::Campfire,
            ...
            [
                ...
                None,
                Some(Node::new(Room::Event, Exit::Straight)),
                Some(Node::new(Room::BurningElite4, Exit::Straight)),
                None,
            ],
            [
                Some(Node::new(Room::Monster, Exit::Right)),
                None,
                Some(Node::new(Room::Event, Exit::Right)),
                Some(Node::new(Room::Monster, Exit::Straight)),
                Some(Node::new(Room::Event, Exit::Left)),
                Some(Node::new(Room::Monster, Exit::Straight)),
                None,
            ...
            [
                None,
                Some(Node::new(Room::Event, Exit::Straight)),
                Some(Node::new(Room::Shop, Exit::Right)),
                Some(Node::new(Room::Monster, Exit::Right)),
                Some(Node::new(Room::Monster, Exit::Straight | Exit::Right)),
                None,
                Some(Node::new(Room::Monster, Exit::Left)),
